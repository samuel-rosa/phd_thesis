...
their contribution to the error in soil spatial modelling is poorly understood. For example, more accurate and 
more detailed covariate data may not necessarily be a better proxy of the soil-forming factors 
\cite{ThompsonEtAl2001, EldeiryEtAl2008, KimEtAl2014}. In very old and stable surfaces of the tropics such as 
described above, current soil properties are more due to past than to present environmental conditions. Present 
day covariate data are not indicators of such environmental conditions. Indeed, some studies have shown that 
\q{degrading} the accuracy of the covariates to produce multi-scale representations of the landscape can yield 
more accurate predictions \cite{Wood1996, ZhuEtAl2008, BehrensEtAl2010a}. However, this approach multiplies the 
number of covariates, increasing the need to better understand the effects of using automated selection 
algorithms in soil spatial modelling.
