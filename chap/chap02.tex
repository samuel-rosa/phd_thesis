...
they were generally unaware of the biasedness of their \emph{model-based} estimates. For some soil spatial 
modellers a solution was to ignore the knowledge on soil-forming factors and use a different model of spatial 
variation: the \emph{continuous model of spatial variation}. Accordingly, the main requirement was that a soil 
property be treated as a regionalized variable, the outcome of a random (stochastic) spatial process 
\cite{Cressie1993, Webster2000}. The theory of \emph{regionalized variables} was laid down during the 1960s by 
the French mathematician Georges Matheron deeply based on the previous work of the South African engineer 
Daniel Krige, the Swedish forestry statistician Bertil Matérn, among others \cite{Krige1951, Matern1960, 
Matheron1965, MatheronEtAl1987, WebsterEtAl2007} -- unfortunately Matheron and colleagues seem to have been 
unaware of the developments made by the Russian mathematician Andrey Kolmogorov in the 1930s and 1940s on the 
...
the covariance \cite{WebsterEtAl1990, Cressie1993}.
