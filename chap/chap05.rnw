...
p <- sp::spplot(
  ...
  panel = function(x, y, ...) {
    ...
    lattice::panel.text(x = sp::coordinates(pol)[1], y = sp::coordinates(pol)[2], labels = "DNOS catchment",
      cex = 0.8)
  })
...
local road network (dashed grey line) surrounding the catchment of the reservoir of the \textit{Departamento 
Nacional de Obras de Saneamento}-\textit{Companhia Riograndense de Saneamento}.}
