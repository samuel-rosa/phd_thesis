...
\def\enkeys{Auxiliary information, Raster data}
...
load("/home/alessandro/projects/dnos-sm-rs/dnos-sm-rs-data/R/color_ramps.RData")
...
# Prepare plot
p1 <- sp::spplot(
  map, main = "", col.regions = color, asp = 1,
  par.settings = list(
    fontsize = list(text = 12, points = 8), layout.widths = list(left.padding = 0, right.padding = 0),
    layout.heights = list(top.padding = 0, bottom.padding = 0)))
# Prepare legend
...
# Prepare plot
p1 <- sp::spplot(
  map, main = "", col.regions = colors, asp = 1, at = breaks, 
  par.settings = list(
    fontsize = list(text = 12, points = 8), layout.widths = list(left.padding = 0, right.padding = 0),
    layout.heights = list(top.padding = 0, bottom.padding = 0)))
...
# Prepare plot
map <- sp::spplot(
  map, main = "", col.regions = sp::bpy.colors(4), asp = 1,
  par.settings = list(
    fontsize = list(text = 12, points = 8), layout.widths = list(left.padding = 0, right.padding = 0),
    layout.heights = list(top.padding = 0, bottom.padding = 0)))
...
# Prepare plot
map <- sp::spplot(
  map, main = "", aspect = 1, col.regions = c("lightgreen", "lightyellow"),
  par.settings = list(
    fontsize = list(text = 12, points = 8), layout.widths = list(left.padding = 0, right.padding = 0),
    layout.heights = list(top.padding = 0, bottom.padding = 0)))
...
# Prepare map
map <- sp::spplot(
  map, aspect = "iso", main = "", col.regions = ndvi$colors, at = ndvi$breaks,
  par.settings = list(
    fontsize = list(text = 12, points = 8), layout.widths = list(left.padding = 0, right.padding = 0),
    layout.heights = list(top.padding = 0, bottom.padding = 0)))
