...
\subcaption{}
\centering
<<soil-old, fig = TRUE, echo = FALSE, include = FALSE>>=
...
\subcaption{}
\centering
<<soil-new, fig = TRUE, echo = FALSE, include = FALSE>>=
...
could be that validation was performed considering only the second level of the SiBCS -- it is likely that 
\soilNew{} would outperform \soilOld{} if validation data included soil taxa up to the fourth level of the 
SiBCS. The low overall purity of \soilOld{} and 
...
\subcaption{}
\centering
<<dem-old, fig = TRUE, echo = FALSE, include = FALSE>>=
...
\subcaption{}
\centering
<<dem-new, fig = TRUE, echo = FALSE, include = FALSE>>=
...
\subcaption{}
\centering
<<geo-old, fig = TRUE, echo = FALSE, include = FALSE>>=
...
\subcaption{}
\centering
<<geo-new, fig = TRUE, echo = FALSE, include = FALSE>>=
...
\subcaption{}
\centering
<<land-old, fig = TRUE, echo = FALSE, include = FALSE>>=
...
\subcaption{}
\centering
<<land-new, fig = TRUE, echo = FALSE, include = FALSE>>=
...
\subcaption{}
\centering
<<land-diff, fig = TRUE, echo = FALSE, include = FALSE>>=
...
\subcaption{}
\centering
<<sat-old, fig = TRUE, echo = FALSE, include = FALSE>>=
...
\subcaption{}
\centering
<<sat-new, fig = TRUE, echo = FALSE, include = FALSE>>=
