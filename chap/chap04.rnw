...
% TODO: figure with GCPs used to ortorectify satellite images. Show the bounding box of the image and the 
% boundary 
% of the study area.
% \begin{figure}
%  \centering
...
satellite images, produced by QuickBird satellite launched in 2001, of the years of \num{2008} and \num{2009}, 
