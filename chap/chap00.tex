...
\subsection{Study area and database}\label{sec:database}
...
developed during the last four years. The second chapter (\hyperref[chap:chapter01]{\textit{Chapter I}}),
is based on an article published in the peer reviewed journal 
...
\ref{sec:database}. The third (\hyperref[apen:spsann]{\textit{Appendix C}}) appendix contains a 
...
All chapters can be read separately, which means that there might some overlap between chapters, 
...
to specific sections of other chapters are made throughout the thesis. All literature references
are presented under a unique \textit{Bibliographic references} section at the end of this thesis.
