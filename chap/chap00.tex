...
was formed with soil experts from all regions of the world \cited{to provide
...
Most soil modellers seem to agree that there is a \q{renewed recognition} of the importance
...
\q{the last agricultural frontier} \cite{Macarini2005,Silva2005}. One could argue that transforming part of
...
Brazilian states that compose \q{the last agricultural frontier}, called MATOPIBA (States of
...
modelling (\refsec{intro-soil-mapping}) and discuss about some of the sources of uncertainty in
soil-mapping projects (\refsec{intro-uncertainty}). Then I present the content of the thesis
...
human settlements, some of which became great, long-standing empires \cite{MazoyerEtAl2008, BrevikEtAl2010, 
Churchman2010}. Archaeological research provides evidence that
...
characterized using one or more direct observations made within the domain of the mapping unit 
\cite{WebsterEtAl1990,Legros2006}.
...
Soil maps would now be produced using a computer, requiring modelling rules to be formalized in the
...
The soil data used to develop the case studies is part of the \emph{Santa Maria dataset} 
...
land use maps (\scale{25000}) \cite{Pedron2005, Miguel2010, SamuelRosaEtAl2011a, MiguelEtAl2012, 
