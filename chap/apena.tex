...
The subset of $n = 340$ soil observations was produced by \citeonline{SamuelRosaEtAl2011a}, 
\citeonline{MiguelEtAl2012}, \citeonline{Moura-BuenoEtAl2012}, and \citeonline{Samuel-RosaEtAl2013}. The 
researchers faced several difficulties with the small budget and shortage of workforce. They also had 
...
soil taxa present in the study area. They also wanted the sample points to be spread throughout the entire 
study area.
...
\subsubsection{Subset 02}

The second subset ($n = 60$) was produced in the years of \num{2012} and \num{2013}. Because of the many
many access limitations (geographic barriers and prohibition by landowners) and shortage of workforce,
budget, infrastructure and time, researchers chose to employ transect sampling
\cite{MiguelEtAl2012,Moura-BuenoEtAl2012,Samuel-RosaEtAl2013}. First, they defined the population of 
transects using their knowledge of the study area, taking into account the factors that determine the 
spatial distribution of soil properties. Each researcher (three) delineated $m = 60$ easy accessible, 
straight transects of \SI{400}{\metre} following the spatial gradients of environmental features (elevation, 
geology, vegetation, land use, and soils). Accordingly, knowledge of exiting roads, human settlements, water
bodies, and other access limitations was used as well. This activity was carried out using Google 
Earth\textregistered{} imagery of the years of \num{2008} and \num{2009}.
...
following the order in which the observations were made (\num{341}--\num{400}).

Observation locations were identified in the field using a GNSS signal receiver with a horizontal 
precision of more than \SI{\pm8}{\metre}. A soil pit was opened within a radius of \SI{2}{\metre} from 
the predefined observation location. Soil sampling and description was carried out using the same procedure 
used with \emph{Subset \num{01}}. Georeferencing was performed using a Differential Global Positioning 
System (DGPS) with centimetric horizontal positional precision.
...
that generated the first subset ($n = 340$) had been made. \citeonline{Pedron2005} and 
\citeonline{Miguel2010}
