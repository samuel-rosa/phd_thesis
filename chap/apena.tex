...
producing semi-detailed soil and land use maps (\scale{25000}) 
...
is identified in the same manner, but using \q{SD}. For example, \q{ORCA\_N} and \q{ORCA\_SD}.
...
Soil coverage with vegetation (\textt) was inferred visually in the field using three classes: 
