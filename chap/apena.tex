...
% GRADUATE COURSE IN AGRONOMY - SOIL SCIENCE (CPGA-CS)
% Dra. Lúcia Helena Cunha dos Anjos
%
% BRAZILIAN AGRICULTURAL RESEARCH CORPORATION (EMBRAPA)
% NATIONAL CENTER FOR RESEARCH ON SOILS (CNPS)
% Dr. Gustavo de Mattos Vasques
%
% WAGENINGEN UNIVERSITY AND RESEARCH CENTRE (WUR)
% ISRIC - WORLD SOIL INFORMATION (ISRIC)
% Dr. Gerard B M Heuvelink
% 
% PROJECT: CONTRIBUTION TO THE CONSTRUCTION OF MODELS
%          FOR PREDICTING SOIL PROPERTIES
% AUTHOR:  Alessandro Samuel Rosa
% PERIOD:  Fev/2012 - Fev/2016
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\artigofalse
