...
of three subsets which are described in the next sections.
...
\tocless\subsubsection{Subset 02}

The second subset ($n = 60$) was produced in the years of \num{2012} and \num{2013}, which was intended to 
...
time, researchers chose to employ transect sampling 
...
System (DGPS) with centimetric positional accuracy.
