...
soil maps. We used a study case from Southern Brazil to map clay content (CLAY), organic carbon content (SOC), 
...
the 
strongest improvement effect. In our study case, the latter would only work for SOC and ECEC, by investing in 
...
to assess the added value of using five more detailed covariates simultaneously. We used a study case in 
Brazil 
