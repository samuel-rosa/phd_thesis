\ctable[
 caption  = [The importance of each covariate in the models calibrated with their two versions.]{The 
importance of each covariate$^a$ ($\Delta{R}^{2}_{adj}{}^b$) in the models calibrated with their less and more 
spatially detailed version.},
