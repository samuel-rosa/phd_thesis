...
plot(brazil)
@
\includegraphics[width=90mm]{fig/chap03-location}
\end{minipage}
\begin{minipage}[b]{95mm}
\subcaption{}
...
@
\includegraphics[width=90mm]{fig/chap03-perspective}
\end{minipage}
\caption[Localização da bacia de captação do reservatório do DNOS/CORSAN, em Santa Maria, RS, 
Brasil]{Localização da bacia de captação do reservatório do DNOS/CORSAN (a) no Município de Santa Maria, Estado 
do Rio Grande do Sul (em verde), Brasil, na porção sul da Província Geológica do Paraná (em cinza). A área de 
estudo (b), em vermelho, corresponde a \SI{\pm60}{\percent} da bacia do DNOS (em azul).}
