...
\def\tacit{A comprehensive explanation of what \emph{tacit knowledge} is, opposed to explicit knowledge, can 
be found in \href{https://en.wikipedia.org/wiki/Tacit_knowledge}{Wikipedia}.}

All observation locations were selected purposively or by convenience. Tacit knowledge\footnote{\tacit} was the 
...
Soil parent material (\texttt{PARENT}, sedimentary or igneous), geological formation (\texttt{GEO}), and 
lithology (\texttt{LITHO}) was inferred from direct observation of soil properties and local environmental 
features in the field. Existing geological maps were used only when soil characteristics and environmental 
features were insufficient to reach an agreement about the most likely soil parent material, geological 
...
\def\sulfochromic{See a detailed description of the sulfochromic solution, or chromic acid, at 
...
sulfochromic solution\footnote{\sulfochromic} [\SI{0.067}{\mole\per\liter} potassium bichromate solution
...
\def\suzuki{As far as I know, a comprehensive description of this method has not been published so far, neither 
in Portuguese nor in English. You can visit the homepage of the Soil Physics Laboratory of the Universidate 
Federal de Santa Maria at \url{https://coral.ufsm.br/fisicadosolo/} to get more information about the method 
or contact their developers.}
...
The analytical procedure is an adaptation\footnote{\suzuki} of the method of the Soil Conservation Service of 
