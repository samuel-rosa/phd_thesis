...
\chapternote{The Portuguese version of this General Introduction is included in 
\autoref{appen:introduction-pt}.}
...
\autoref{chap:chap02} is a commented review of the literature on soil spatial modelling and its main sources of 
...
\autoref{chap:chap04} describes the soil data included in the \emph{Santa Maria dataset}, which was used to 
