...
gradient,
  ...
  \item[\texttt{SOIL\_25c}] Low weathered soil (Cambissolo Háplico; Cambisol) and shallow soil with low to 
high 
base
...
Brazilian 
legislation, high-quality map standards require that at least 90% of the GCPs have horizontal positional 
errors 
...
using 
the \Rpackage{vec2dtransf} \cite{Carrillo2012} to correct this systematic error. Model parameters were 
adjusted 
...
meet the high-quality standards of current Brazilian legislation, which states that 90% of the GCPs should 
have 
