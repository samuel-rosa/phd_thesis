...
exercise was carried out because these maps originally had no accompanying validation information.
...
\subcaption{}
\centering
\includegraphics{fig/chap05-002}
\end{minipage}
\begin{minipage}[b]{63mm}
\subcaption{}
\centering
\includegraphics{fig/chap05-003}
\end{minipage} 
...
% and \soilNew{} in the attribute space. Azimuth values were estimated using, respectively, four and XX
% ground control pointsGCPs located in easily identifiable geographical markers, respectively. Estimates were 
% corrected to the size of the 
...
Both \soilOld{} and \soilNew{} were cropped to the bounding box of the study area, and resampled geometrically 
corrected 
...
Brazilian 
Army (\scale{25000}) that cover the study area \cite{DSG1980, DSG1992, DSG1992a}. Topographic sheetsmaps were 
digitalized
...
\SI{1315}{\metre}, and an overall horizontal error (i.e. RMSE) smaller than \SI{8}{\metre} at the \scale{25000}
...
% space. Azimuth values were estimated using 14 ground control pointsGCPs located in easily identifiable 
...
\subcaption{}
\centering
\includegraphics{fig/chap05-004}
\end{minipage}
\begin{minipage}[b]{63mm}
\subcaption{}
\centering
\includegraphics{fig/chap05-005}
\end{minipage} 
...
of 
\demNew{}, which was derived from contour lines published at a \scale{25000}, the vertical positional estimated 
accuracy does not 
...
% \tt{ELEV\_10} has a 50\% probability that absolute errors are below 15 m, \tt{ELEV\_90} has 
...
% \begin{Schunk}
% \begin{Soutput}
% Exporting 33 areas (may take some time)...
%    3%   6%   9%  12%  15%  18%  21%  24%  27%  30%  33%  36%  39%  42%  45%  48%  51%  54%  57%  60%  63%  66%  69%  72%  75%  78%  81%  84%  87%  90%  93%  96% 100%
% v.out.ogr complete. 33 features written to <poly> (ESRI_Shapefile).
% OGR data source with driver: ESRI Shapefile 
% Source: "/home/lgcs-mds/dbGRASS/dnos-sm-rs/predictions/.tmp/lgcs-mds", layer: "poly"
% with 33 features
% It has 3 fields
% \end{Soutput}
% \begin{Soutput}
%            used  (Mb) gc trigger  (Mb) max used  (Mb)
% Ncells   654763  35.0    2276774 121.6  3986227 212.9
% Vcells 36399679 277.8   97206706 741.7 96803749 738.6
% \end{Soutput}
% \end{Schunk}
% \includegraphics{fig/chap05-007}
% \end{minipage} 
...
%  estimated using, respectively, eight and five ground control pointsGCPs located in easily identifiable 
% geographical 
...
%   the Santa Maria dataset such as (c) \tt{LUdiff}, the land use changedifference between the years of 1980 and 
%   2009.}
...
The second source of satellite images is the RapidEye constellation of five satellites, launched in August 
...
\cite{VermoteEtAl1997} employing the Fortran code developed by \citeonline{AntunesEtAl2013} -- 
\grass{i.atcorr} was not used because a \atcorrbug{} was found when trying to correct the RapidEye images from 
the RapidEye 
