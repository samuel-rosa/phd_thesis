...
\begin{figure}[!ht]
 ...
 \begin{minipage}[b]{95mm}
  ...
  \centering
  \includegraphics[width=90mm]{chap/fig/chap05FIG1a}
 \end{minipage}
 \begin{minipage}[b]{95mm}
  \subcaption{}
  \label{fig:chap05-points}
  \centering
  \includegraphics[width=90mm]{chap/fig/chap05FIG1b}
 \end{minipage}
...
\begin{figure}[!ht]
 ...
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \centering
  \includegraphics[width=63mm]{chap/fig/chap05FIG2a}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \centering
  \includegraphics[width=63mm]{chap/fig/chap05FIG2d}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \centering
  \includegraphics[width=63mm]{chap/fig/chap05FIG2b}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \centering
  \includegraphics[width=63mm]{chap/fig/chap05FIG2e}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \centering
  \includegraphics[width=63mm]{chap/fig/chap05FIG2c}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \centering
  \includegraphics[width=63mm]{chap/fig/chap05FIG2f}
 \end{minipage}
...
\begin{figure}[!ht]
 ...
 \begin{minipage}[b]{63mm}
  ...
  \centering
  \includegraphics[width=60mm]{chap/fig/chap05FIG3a}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{Cartographic scale: \num{1}:\num{25000}}
  \label{fig:chap05-soil-new}
  \centering
  \includegraphics[width=60mm]{chap/fig/chap05FIG3d}
 \end{minipage}    
 \begin{minipage}[b]{63mm}
  \subcaption{Cartographic scale: \num{1}:\num{50000}}
  \label{fig:chap05-geo-old}
  \centering
  \includegraphics[width=60mm]{chap/fig/chap05FIG3b}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{Cartographic scale: \num{1}:\num{25000}}
  \label{fig:chap05-geo-new}
  \centering
  \includegraphics[width=60mm]{chap/fig/chap05FIG3e}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{Cartographic scale: \num{1}:\num{500000}}
  \label{fig:chap05-land-old}
  \centering
  \includegraphics[width=60mm]{chap/fig/chap05FIG3c}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{Cartographic scale: \num{1}:\num{2000}}
  \label{fig:chap05-land-new}
  \centering
  \includegraphics[width=60mm]{chap/fig/chap05FIG3f}
 \end{minipage}
...
\emph{model series plot} (\Rpackage{pedometrics}, \citeonline{Samuel-RosaEtAl2014c}). Pedological evaluation 
of 
...
\begin{figure}[!ht]
 ...
 \begin{minipage}[b]{\textwidth}
  \subcaption{}
  \includegraphics[width=\textwidth]{chap/fig/chap05FIG5a}
 \end{minipage}
 \begin{minipage}[b]{\textwidth}
  \subcaption{}
  \includegraphics[width=\textwidth]{chap/fig/chap05FIG5b}
 \end{minipage}
 \begin{minipage}[b]{\textwidth}
  \subcaption{}
  \includegraphics[width=\textwidth]{chap/fig/chap05FIG5c}
 \end{minipage}
...
means that the relative benefit of calibrating a SOC model with a more detailed land use map is larger 
compared 
...
\begin{figure}[!ht]
 ...
 \begin{minipage}[b]{90mm}
  \subcaption{}
  \includegraphics[width=90mm]{chap/fig/chap05FIG6a} 
 \end{minipage}
 \begin{minipage}[b]{90mm}
  \subcaption{}
  \includegraphics[width=90mm]{chap/fig/chap05FIG6b}
 \end{minipage}
 \begin{minipage}[b]{90mm}
  \subcaption{}
  \includegraphics[width=90mm]{chap/fig/chap05FIG6c}
 \end{minipage}
...
\begin{figure}[!ht]
 ...
 \begin{minipage}[b]{63mm}
  ...
  \centering
  \includegraphics[width=63mm]{chap/fig/chap05FIG7a}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \label{fig:chap05-clay-best-pred}
  \centering
  \includegraphics[width=63mm]{chap/fig/chap05FIG7d}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \label{fig:chap05-soc-base-pred}
  \centering
  \includegraphics[width=63mm]{chap/fig/chap05FIG7b}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \label{fig:chap05-soc-best-pred}
  \centering
  \includegraphics[width=63mm]{chap/fig/chap05FIG7e}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \label{fig:chap05-ecec-base-pred}
  \centering
  \includegraphics[width=63mm]{chap/fig/chap05FIG7c}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \label{fig:chap05-ecec-best-pred}
  \centering
  \includegraphics[width=63mm]{chap/fig/chap05FIG7f}
 \end{minipage}
...
\begin{figure}[!ht]
 ...
 \begin{minipage}[b]{63mm}
  ...
  \centering
  \includegraphics[width=60mm]{chap/fig/chap05FIG8a}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \label{fig:chap05-clay-best-var}
  \centering
  \includegraphics[width=60mm]{chap/fig/chap05FIG8d}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \label{fig:chap05-soc-base-var}
  \centering
  \includegraphics[width=60mm]{chap/fig/chap05FIG8b}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \label{fig:chap05-soc-best-var}
  \centering
  \includegraphics[width=60mm]{chap/fig/chap05FIG8e}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \label{fig:chap05-ecec-base-var}
  \centering
  \includegraphics[width=60mm]{chap/fig/chap05FIG8c}
 \end{minipage}
 \begin{minipage}[b]{63mm}
  \subcaption{}
  \label{fig:chap05-ecec-best-var}
  \centering
  \includegraphics[width=60mm]{chap/fig/chap05FIG8f}
 \end{minipage}
