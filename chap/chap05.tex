...
Ncells 584791 31.3     940480 50.3   892587 47.7
Vcells 759471  5.8    1650153 12.6  1307480 10.0
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
           used (Mb) gc trigger  (Mb) max used  (Mb)
Ncells  1428142 76.3    2487386 132.9  3675969 196.4
Vcells 11921187 91.0   31666781 241.6 31631870 241.4
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
           used (Mb) gc trigger  (Mb) max used  (Mb)
Ncells  1428365 76.3    4298049 229.6  5372562 287.0
Vcells 12970803 99.0   36656129 279.7 36621015 279.4
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
           used (Mb) gc trigger  (Mb) max used  (Mb)
Ncells  1427640 76.3    4158126 222.1  5372562 287.0
Vcells 12579518 96.0   42403859 323.6 42370441 323.3
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
           used (Mb) gc trigger  (Mb) max used  (Mb)
Ncells  1428790 76.4    4023800 214.9  5372562 287.0
Vcells 12581604 96.0   39255394 299.5 42370441 323.3
\end{Soutput}
\end{Schunk}
\includegraphics{fig/chap05-006}
\end{minipage} 
...
\begin{Soutput}
           used  (Mb) gc trigger  (Mb) max used  (Mb)
Ncells  1901034 101.6    4023800 214.9  5372562 287.0
Vcells 13295417 101.5   56246024 429.2 69753012 532.2
\end{Soutput}
\begin{Soutput}
           used  (Mb) gc trigger  (Mb) max used  (Mb)
Ncells  1908943 102.0    4023800 214.9  5372562 287.0
Vcells 28530435 217.7   67575228 515.6 69753012 532.2
\end{Soutput}
\end{Schunk}
\includegraphics{fig/chap05-covar-data-slope}
\caption[Slope derived using windows of different sizes.]{Slope \texttt{SLP}} raster surfaces derived from 
\demNew{} using windows of sizes (from left to right) $3 \times 3$, $31 times 31$, and $255 \times 255$.}
...
\subcaption{}
\centering
\includegraphics{fig/chap05-sat-old}
\end{minipage}
\begin{minipage}[b]{63mm}
\subcaption{}
\centering
\includegraphics{fig/chap05-sat-new}
\end{minipage} 
