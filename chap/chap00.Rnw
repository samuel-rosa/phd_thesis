...
\citep{Basher1997, HarteminkEtAl2008, Grunwald2009, SanchezEtAl2009, Finke2012}. Many soil 
scientists pointed out several economical, political, and cultural reasons to explain the general 
lack of interest in soil information after the 1980's without coming to an agreement. Fortunately, 
the landscape has changed dramatically since the last decade. Soil science is now experiencing a 
period of renaissance \citep{HarteminkEtAl2008}. Soils are back on the agenda \citep{Kempen2011}. 
Soil is now a hot topic at both local and global scales. Again, defining the reasons for increased 
funding of soil mapping 
and soil-related research is a quite complex task. 
Some believe that it is a result of the global understanding that soil information is needed to 
solve what has been defined as the five major problems of our time: food security, climate change, 
environmental degradation, water scarcity, and threats to the biodiversity \citep{SanchezEtAl2009}.

It is a result of a new global demand for soil 
...
scarcity and threats to the biodiversity \citep{SanchezEtAl2009}. The Food and 
