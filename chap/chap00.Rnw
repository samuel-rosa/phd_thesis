...
in Brazil \citep{Dalmolin1999, Ker1999, KerEtAl2003, Mendonca-SantosEtAl2003, Ramos2003, 
Espindola2008}, but in many countries around the world \citep{Basher1997, HarteminkEtAl2008, 
Grunwald2009, SanchezEtAl2009, Finke2012}. They pointed out several reasons to explain the general 
lack of interest in soil information by governments after the 1980's. But all of them seem to agree 
on one point: cutting down the budget for soil modelling/mapping fundamentally was an economic 
decision in which the general public was not given the chance to participate \citep{SamuelRosa2012}.
...
\citep{Kempen2011}. Soil is now a hot topic. For example, the United Nations 
...
\q{the last agriculture frontier} \citep{Macarini2005, Silva2005}. One could argue that transforming part of
...
lack of food \citep{FAO2005, FAO2009, FAO2015} -- it is well known that about \SI{50}{\percent} of the
produced food is lost, even in rich countries such as Switzerland \citep{BerettaEtAl2013}. The 
...
to solve the major issues in the region \citep{SECOM2015}. Simply put, I believe that the growing 
...
empires had more formal \emph{soil classification systems} and \emph{soil survey programs}, in most cases 
...
characterized using one or more direct observations made within the domain of the mapping unit \citep{WebsterEtAl1990, Legros2006}.
...
soil property be treated as a stochastic variable \citep{Cressie1993}, i.e. as if it was impossible to be 
...
mathematical form \citep{OdehEtAl1994, OdehEtAl1995, Heuvelink1996, McBratneyEtAl2000, HenglEtAl2004, 
Lopez-GranadosEtAl2005, WebsterEtAl2007, Grunwald2009, Lark2012}. These features, and the development 
...
variation \citep{PoggioEtAl2014, NussbaumEtAl2014, HenglEtAl2015}.
...
represented a \q{paradigm shift} in soil science \citep{McBratneyEtAl2003} and that it is the 
...
mathematics, statistics, and informatics \citep{Webster2001, SamuelRosa2012}.
...
\citet{Jenny1941} when comparing \cited{soil geographers} and \cited{soil functionalists}. The view that I
...
insights about how the soil came to be and how they should be managed \citep{Jenny1941, Hudson1992,
Legros2006, Blanco-CanquiEtAl2010, Grunwald2010}. This is the reason why, irrespective of the method/model
...
\citep{MooreEtAl1993, OdehEtAl1994, GesslerEtAl1995, McKenzieEtAl1999, GobinEtAl2001, SumflethEtAl2008,
...
important source of uncertainty \citep{HeuvelinkEtAl1999, RefsgaardEtAl2006}. In the case of the 
...
region \citep{BrusEtAl2007a}. However, most soil-mapping projects must rely on using only soil 
data produced many years ago \citep{KempenEtAl2009, HenglEtAl2014, PoggioEtAl2014, NussbaumEtAl2014,
MulderEtAl2016}, when most sampling locations were chosen by soil modellers/mappers using non-explicit
location rules, usually placing more samples in complex and less known areas \citep{Rossiter2000}.
...
trend \citep{HenglEtAl2003a, MinasnyEtAl2006b} and the variogram model \citep{WarrickEtAl1987,
WebsterEtAl1992, Lark2002}, making spatial predictions \citep{YfantisEtAl1987, WalvoortEtAl2010} and,
(cross)validating the model/map \citep{BrusEtAl2011}, four often conflicting objectives. Besides, one
...
modelling benefits that do not outweigh the sampling costs \citep{vanGroenigenEtAl1999}.
...
every soil modeller/mapper with long practical experience in soil mapping \citep{MeyerEtAl2001}. 
...
a stable one \citep{Schumm1979}. As the landscape is rejuvenated, thus increasing complexity, establishing 
...
solely on mental models \citep{Hudson1992}. Later, many soil-mapping projects used statistical 
models that assume a linear relation \citep{MooreEtAl1993, OdehEtAl1994}. Developments in 
...
support vector machines, among many others \citep{HeungEtAl2016}. The main reason being that these
non-linear models have a greater ability to capture more complex site-specific soil-landscape relations
\citep{Grunwald2009}. In fact, the relation between soil properties and covariates seldom is 
completely linear \citep{McKenzieEtAl1999}. Once again, the problem is that each model produces a 
different soil map, although the validation statistics may suggest that the differences in their 
performance are insignificant \citep{HeungEtAl2016}. A solution is to aggregate the predictions of 
...
be devoid of any pedological information \citep{Grunwald2009}.
...
of error that we were not aware of -- the \emph{unknown unknowns} \citep{Wikipedia2015}. If a known 
...
also called \emph{uncertainty analysis} \citep{HeuvelinkEtAl1989, Taylor1997}. This is done taking
...
we already known -- the \emph{unknown knowns} \citep{Zizek2006}.
...
temperatures \citep{HeldweinEtAl2009} --, and mean annual precipitation of \SI{1708}{\milli\metre} well
...
\citep{GasparettoEtAl1988, MacielFilho1990, Sartori2009}. Consolidated sedimentary rocks (fluvial 
...
soil and land use maps (\scale{25000}) \citep{Pedron2005, Miguel2010, SamuelRosaEtAl2011a, MiguelEtAl2012,
Samuel-RosaEtAl2013}, and predicting the vulnerability of the topsoil to erosion \citep{MouraBueno2012,
Miguel2013}. The Santa Maria dataset, which is freely available at ISRIC World Soil Information Service
