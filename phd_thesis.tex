...
%% Definição do espaço antes e depois das equações
%% http://tex.stackexchange.com/a/69665/62889
\makeatletter
\g@addto@macro\normalsize{%
...
%% Numeração (como capítulo) de "Referências Bibliográficas"
...
%% Referências
%%=============================================================================
\shorttitle{Bibliographic References}
