...
\include{chap/chap00} % 1. General introduction
% \include{chap/chap01} % 2. 
\selectlanguage{brazilian}
\include{chap/chap02} % 3. Modelo conceitual de pedogênese
\selectlanguage{english}
% \include{chap/chap03} % 4. The Santa Maria dataset -- soil data
% \include{chap/chap04} % 5. The Santa Maria dataset -- covariate data
\include{chap/chap05} % 6. Do more detailed covariates deliver more accurate soil maps?
\include{chap/chap06} % 7. Spatial point pattern analysis of soil survey sampling locations
\include{chap/chap07} % 8. Optimization of sample configurations for spatial trend estimation for soil mapping
\include{chap/chap08} % 9. Sampling for soil mapping in terra incognita
