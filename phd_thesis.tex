...
\include{chap/chap00} % General introduction
% \include{chap/chap01}
\selectlanguage{brazilian}\citeoption{abnt-and-type=e}
\include{chap/chap02} % Modelo conceitual de pedogênese
\selectlanguage{english}\citeoption{abnt-and-type=&}
% \include{chap/chap03} % The Santa Maria dataset -- soil data
% \include{chap/chap04} % The Santa Maria dataset -- covariate data
\include{chap/chap05} % Do more detailed covariates deliver more accurate soil maps?
%TODO: 
\include{chap/chap06} % Spatial point pattern analysis of soil survey sampling locations
\include{chap/chap07} % Optimization of sample configurations for spatial trend estimation for soil mapping
\include{chap/chap08} % Sampling for soil mapping in terra incognita
